...
class Data:
    ...
    def getRobotAction(self):
        return self.getRobotActionFromPolicy(self.currState, self.bel_t)

    def receiveHumanRobotAction(self, humanAction, robotAction):
    ...
    def getCurrentTableTheta(self):
        return self.getTableThetaFromState(self.currState)
